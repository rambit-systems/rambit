...
pub fn DashboardPage() -> impl IntoView {
  view! {
    <div class="flex flex-col md:grid xl:grid-cols-[320px_minmax(0,_1fr)] gap-4 md:place-items-start">
      ...
      <RequestedOrgTile {..} class="md:place-self-end xl:place-self-auto md:w-80" />
      <div class="flex-1 md:col-span-2 xl:col-span-1 flex flex-col md:grid gap-4 md:grid-cols-2 md:place-self-stretch">
